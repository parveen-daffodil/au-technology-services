...
### Provider does all the setup.

Provider is responsible for the setup and installation of the Services.

### Provider does all the setup except for certain tasks.

Provider is responsible for the setup and installation of the Services, except for:

{{setup exceptions}}

### Provider does none of the setup.
...
- The Contractor reserves the right to alter any aspect of the Services at its discretion.
- Won't reverse engineer.
- No assignment or use unless set out in this agreement.
- [should be a separate topic? or possibly part of IP protection?]
